...
def search(prog):
  ...
  %s rcp85 3hr query=209101010300-209601010000 -f 
  %s 20160101-20161231 "Air Temperature" -f
  ...
  %s cmip5.output1.CCCma.CanESM2.historicalGHG.fx.atmos.fx.r0i0p0.v20120410.orog_fx_CanESM2_historicalGHG_r0i0p0.nc"""%((prog,)*26)
