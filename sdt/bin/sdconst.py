...
TRANSFER_PROTOCOL_GLOBUS_ONLINE='globus_online'

TRANSFER_PROTOCOLS=[TRANSFER_PROTOCOL_HTTP,TRANSFER_PROTOCOL_GRIDFTP,TRANSFER_PROTOCOL_GLOBUS_ONLINE]
...
ADMIN_SUBCOMMANDS=['autoremove','certificate','install','pexec','remove','reset','retry','update','upgrade']
