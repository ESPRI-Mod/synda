...
#                             All Rights Reserved”
#  @svn_file       $Id: sdremotequtils.py 12605 2014-03-18 07:31:36Z jerome $
#  @version        $Rev: 12638 $
...
def build_url(facets):
    ...
    url="http://{0}/esg-search/search?{1}&format=application%2Fsolr%2Bxml".format(sdconst.IDXHOSTMARK,serialized_parameters)
