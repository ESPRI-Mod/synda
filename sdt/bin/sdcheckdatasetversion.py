...
def run(args):
    ...
    all_dsv = sddump.dump_ESGF(parameter=['type=Dataset']+args.parameter,fields='master_id,version,timestamp',dry_run=args.dry_run,record=args.record,playback=args.playback)
