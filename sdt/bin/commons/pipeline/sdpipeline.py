...
from sdt.bin.commons.facets import sdshrink
...
from sdt.bin.commons.pipeline import sdgenericpipeline
from sdt.bin.commons.pipeline import sdfilepipeline
from sdt.bin.commons.pipeline import sddatasetpipeline
...
def main_pipeline(files, mode=None):
    ...
    if mode == 'file':
        ...
        raise sdexception.SDException("SDPIPELI-001", "Incorrect mode ({})".format(mode))
