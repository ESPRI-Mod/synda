...
def is_admin():
    ...
    return sdtools.is_file_read_access_OK(sdconfig.credential_file)
...
def stop():
    if is_running():
        ...
        if psutil.pid_exists(pid):
            ...
            sdlog.error('SDDAEMON-014',
                        "Warning: daemon pidfile exists but daemon process doesn't exist. Most often, this is caused by an unexpected system restart (e.g. kernel panic).")
