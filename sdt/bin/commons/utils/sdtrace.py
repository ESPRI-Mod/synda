...
def log_message(msg):
    frame, outer_filename, outer_line_number, outer_function_name, lines, index = inspect.stack()[
        1]  # warning: must stay in this func

    with open(sdconfig.stacktrace_log_file, 'a') as fh:
        fh.write("=============\n")
        fh.write("Trace function called from '{}' file in '{}' function at line {}\n".format(outer_filename,
                                                                                             outer_function_name,
                                                                                             outer_line_number))
        fh.write("Message printed at {}\n".format(datetime.datetime.now()))
        fh.write('{}\n'.format(msg))
