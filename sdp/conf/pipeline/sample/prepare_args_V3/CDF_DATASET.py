...
t1 = Transition(name='latest', destination='S2600', get_args=get_args)
t2 = Transition(name='latest', destination='S2700', get_args=get_args)

s1 = State(name='S2500', transition=t1, initial=True)
s2 = State(name='S2600', transition=t2)
s3 = State(name='S2700', transition=None)
