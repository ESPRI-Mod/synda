...
t5=Transition(name='suppression_variable',destination='S0600',get_args=f3)
t6=Transition(name='copy',destination='S0700',get_args=f4)
t7=Transition(name='cdscan',destination='S0800',get_args=f4)
t8=Transition(name='latest',destination='S0900',get_args=f5)
t9=Transition(name='mapfile',destination='S1000',get_args=f5)
...
s10=State(name='S1000',transition=None)

ppp.add(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10)
