...
name = 'CDF_INT_DATASET'
ppp = PostProcessingPipeline(name)

t1 = Transition(name='latest', destination='S2400', get_args=get_args)

s1 = State(name='S2300', transition=t1, initial=True)
s2 = State(name='S2400', transition=None)
