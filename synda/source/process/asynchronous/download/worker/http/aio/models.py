...
from synda.source.process.asynchronous.download.worker.http.aio.task.small_file.models import Task as HttpSmallFileTask
from synda.source.process.asynchronous.download.worker.http.aio.task.big_file.models import Task as HttpBigFileTask
