...
from synda.source.process.asynchronous.download.worker.http.blocking.myrequests.task.small_file.models \
    import Task as SmallFileTask
from synda.source.process.asynchronous.download.worker.http.blocking.myrequests.task.big_file.models \
    import Task as BigFileTask
...
class Worker(Base):
    ...
    def __init__(self, name, queue, manager):
        ...
        Base.__init__(self, name, queue, manager, SmallFileTask, BigFileTask)
