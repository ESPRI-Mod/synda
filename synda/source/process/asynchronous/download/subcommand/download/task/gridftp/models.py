...
from synda.source.process.asynchronous.download.task.gridftp.models import Task as Base
from synda.source.process.asynchronous.download.task.gridftp.processes import Process as DownloadProcess
