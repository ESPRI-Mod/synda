...
class Context(Base):
    ...
    def validation_after_subcommand_execution(self):
        ...
        assert config['core']['selection_path'] in preferences.core_selection_path
        assert config['core']['default_path'] in preferences.core_default_path
        assert config['core']['db_path'] in preferences.core_db_path
        assert config['core']['data_path'] in preferences.core_data_path
        assert config['core']['sandbox_path'] in preferences.core_sandbox_path
