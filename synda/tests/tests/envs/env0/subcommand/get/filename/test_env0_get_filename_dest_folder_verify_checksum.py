...
def test_env0_get_filename_context_dest_folder_verify_checksum(
        env0_get_file_context_dest_folder_verify_checksum,
        capsys,
):

    context = env0_get_file_context_dest_folder_verify_checksum
    ...
    from synda.tests.subcommand.get.filename.models import VerifyChecksumSubCommand as SubCommand
