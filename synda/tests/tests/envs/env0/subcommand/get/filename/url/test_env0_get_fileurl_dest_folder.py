...
def test_env0_get_fileurl_dest_folder(env0_get_file_context_dest_folder, capsys):

    context = env0_get_file_context_dest_folder

    url = SYNDA_DEV_DATA["cordex"]["urls"][0]
    ...
    context.set_file(url, dest_folder=dest_folder)
    ...
    from synda.tests.subcommand.get.filename.models import DestFolderSubCommand as SubCommand
