...
def test_env0_get_filename_config_default_openid(env0_get_filename_config_default_openid_context, capsys):

    context = env0_get_filename_config_default_openid_context
    ...
    from synda.tests.subcommand.get.filename.no_credentials.config.openid.default.models import SubCommand
