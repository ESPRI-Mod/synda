...
def test_env0_get_filename_cli_unknown_openid(env0_get_filename_cli_unknown_openid_context, capsys):

    context = env0_get_filename_cli_unknown_openid_context
    ...
    from synda.tests.subcommand.get.filename.no_credentials.cli.openid.unknown.models import SubCommand
