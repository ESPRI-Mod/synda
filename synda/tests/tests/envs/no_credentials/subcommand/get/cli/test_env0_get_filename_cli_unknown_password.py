...
def test_env0_get_filename_cli_unknown_password(env0_get_filename_cli_unknown_password_context, capsys):

    context = env0_get_filename_cli_unknown_password_context
    ...
    from synda.tests.subcommand.get.filename.no_credentials.cli.password.unknown.models import SubCommand
