...
def test_env0_get_filename_cli_default_openid(env0_get_filename_cli_default_openid_context, capsys):

    context = env0_get_filename_cli_default_openid_context
    ...
    from synda.tests.subcommand.get.filename.no_credentials.cli.openid.default.models import SubCommand
