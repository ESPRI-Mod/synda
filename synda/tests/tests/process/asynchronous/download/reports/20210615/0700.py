...
strategies = [
    "current version",
    "asyncio requests  (big file threshold size : {} Bytes)".format(big_file_size),
...
min_start_date = datetime.datetime.strptime('2021-06-11 13:46:30.508903', "%Y-%m-%d %H:%M:%S.%f")
...
{'file_id': 29, 'status': 0, 'name': '0 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/ph/ph_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'observed_size': 135602056, 'expected_size': 135602056, 'duration': 2.336043, 'start_date': '2021-06-15 06:59:23.603294', 'end_date': '2021-06-15 06:59:25.939337', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/ph_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'process_name': 'big file task'},
{'file_id': 35, 'status': 0, 'name': '4 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/si/si_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'observed_size': 135602100, 'expected_size': 135602100, 'duration': 2.01081, 'start_date': '2021-06-15 06:59:23.935080', 'end_date': '2021-06-15 06:59:25.945890', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/si_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'process_name': 'big file task'},
{'file_id': 11, 'status': 0, 'name': '1 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/co3/co3_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'observed_size': 135602156, 'expected_size': 135602156, 'duration': 1.742071, 'start_date': '2021-06-15 06:59:24.204354', 'end_date': '2021-06-15 06:59:25.946425', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/co3_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'process_name': 'big file task'},
{'file_id': 15, 'status': 0, 'name': '6 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/detoc/detoc_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'observed_size': 135602216, 'expected_size': 135602216, 'duration': 1.381429, 'start_date': '2021-06-15 06:59:24.565434', 'end_date': '2021-06-15 06:59:25.946863', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/detoc_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'process_name': 'big file task'},
{'file_id': 17, 'status': 0, 'name': '3 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/dfe/dfe_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'observed_size': 135602240, 'expected_size': 135602240, 'duration': 1.04794, 'start_date': '2021-06-15 06:59:24.899319', 'end_date': '2021-06-15 06:59:25.947259', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/dfe_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1950-1989.nc', 'process_name': 'big file task'},
{'file_id': 26, 'status': 0, 'name': '5 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/o2/o2_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1850-1949.nc', 'observed_size': 337361464, 'expected_size': 337361464, 'duration': 1.003168, 'start_date': '2021-06-15 06:59:25.265050', 'end_date': '2021-06-15 06:59:26.268218', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/o2_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1850-1949.nc', 'process_name': 'big file task'},
{'file_id': 18, 'status': 0, 'name': '7 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/dissic/dissic_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1850-1949.nc', 'observed_size': 337361572, 'expected_size': 337361572, 'duration': 1.004992, 'start_date': '2021-06-15 06:59:25.600420', 'end_date': '2021-06-15 06:59:26.605412', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/dissic_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1850-1949.nc', 'process_name': 'big file task'},
{'file_id': 14, 'status': 0, 'name': '2 , http://vesgint-data.ipsl.upmc.fr/thredds/fileServer/cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/detoc/detoc_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1850-1949.nc', 'observed_size': 337361576, 'expected_size': 337361576, 'duration': 1.002811, 'start_date': '2021-06-15 06:59:25.938235', 'end_date': '2021-06-15 06:59:26.941046', 'strategy': 'asyncio wget (script)', 'sdget_status': None, 'sdget_error_msg': None, 'local_path': 'cmip5/output1/IPSL/IPSL-CM5A-LR/1pctCO2/yr/ocnBgchem/Oyr/r1i1p1/v20180314/detoc_Oyr_IPSL-CM5A-LR_1pctCO2_r1i1p1_1850-1949.nc', 'process_name': 'big file task'},
