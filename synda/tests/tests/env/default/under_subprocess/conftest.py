...
from synda.tests.context.getinfo.filename.models import Context as GetInfoFilenameContext
...
from synda.tests.context.envs.env1.subcommand.api.esgf_search.count.usercase.cmip5.dataset.models import Context as \
    CountDatasetsContextForCmip5UserCase

from synda.tests.context.envs.env1.subcommand.api.esgf_search.count.usercase.cmip5.file.models import Context as \
...
from synda.tests.context.envs.env1.subcommand.api.esgf_search.search.file.models import Context as FileSearchContext
...
@pytest.fixture
def getinfo_filename_context():
    context = GetInfoFilenameContext()
    return context
