...
"""
 ...
 Specifications : USER-PREFERENCES-01a
...
from synda.tests.tests.config.file.user.preferences.install.interactive.false.constants \
...
def test_specif_user_preferences_01a():
    assert config.is_install_interactive is False
