...
from synda.tests.tests.config.file.user.preferences.install.interactive.true.constants \
...
def test_specif_user_preferences_01b():
    assert config.is_install_interactive is True
