...
from synda.tests.process.envs.build.env4.constants import DATA_DIRECTORY
from synda.tests.process.envs.build.env4.constants import PREFERENCES_FILE_RESOURCES_DIRECTORY
