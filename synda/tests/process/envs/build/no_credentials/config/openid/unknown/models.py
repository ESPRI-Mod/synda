...
from synda.tests.process.envs.build.no_credentials.config.openid.default.constants import DATA_DIRECTORY
from synda.tests.process.envs.build.no_credentials.config.openid.default.constants import PREFERENCES_FILE_RESOURCES_DIRECTORY
