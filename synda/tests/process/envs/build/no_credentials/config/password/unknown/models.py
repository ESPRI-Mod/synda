...
from synda.tests.process.envs.build.no_credentials.config.password.unknown.constants import DATA_DIRECTORY
from synda.tests.process.envs.build.no_credentials.config.password.unknown.constants import PREFERENCES_FILE_RESOURCES_DIRECTORY
...
class Process(Base):
    ...
    def customize(self):
        self.overwrite_credentials_file()

    def overwrite_credentials_file(self):
