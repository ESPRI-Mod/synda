...
from synda.tests.process.envs.build.no_credentials.config.password.unknown.models import Process
...
if __name__ == '__main__':
    ...
    print(f"new environment created : {config.env_file_destination}")
