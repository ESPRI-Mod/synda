...
from synda.tests.process.envs.build.env5.constants import DATA_DIRECTORY
from synda.tests.process.envs.build.env5.constants import PREFERENCES_FILE_RESOURCES_DIRECTORY
