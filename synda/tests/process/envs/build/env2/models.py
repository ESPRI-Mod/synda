...
from synda.tests.process.envs.build.env2.constants import DATA_DIRECTORY
from synda.tests.process.envs.build.env2.constants import DB_RESOURCES_DIRECTORY
